...
const ShellCenterRow = class {
    ...
    render() {
        const { el } = this;
        const contentNode = (index.h("div", { key: '31239015e9582ebbe43f3fe7a6b8fb6b2750b0d7', class: CSS$1.content }, index.h("slot", { key: 'eee4b393dfa79405d9a48e6c2db016017a6e9a1f' })));
