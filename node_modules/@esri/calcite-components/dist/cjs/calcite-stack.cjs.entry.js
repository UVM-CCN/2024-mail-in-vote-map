...
const Stack = class {
    ...
    render() {
        return (index.h(index.Host, { key: '97f052828720d715fd3b11a4b0e77fa085127796' }, index.h("div", { key: '5351cc20a8a437763894fef35ecc7a7240cb7c46', class: resources.CSS.container }, this.renderActionsStart(), this.renderContentStart(), this.renderDefaultContent(), this.renderContentEnd(), this.renderActionsEnd())));
    }
};
