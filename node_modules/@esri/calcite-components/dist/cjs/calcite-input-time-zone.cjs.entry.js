...
const locale = require('./locale-783be19a.js');
const t9n = require('./t9n-5f0809e3.js');
const loadable = require('./loadable-1e343f4a.js');
const form = require('./form-26bde25c.js');
require('./dom-401c47fa.js');
require('./guid-7487a6a8.js');
require('./resources-8d0a3a55.js');
require('./component-25eaec79.js');
require('./key-8032a9dc.js');
require('./observers-dc37fb24.js');
require('./browser-b9024aa0.js');
...
async function getNormalizer(mode) {
    ...
    const { normalize } = await Promise.resolve().then(function () { return require('./time-zones-b0ae45d1.js'); });
    return normalize;
}
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await Promise.resolve().then(function () { return require('./index-34f1d139.js'); });
    ...
    if (mode === "region") {
        const [{ groupByRegion }, { getCountry, global: globalLabel }] = await Promise.all([
            Promise.resolve().then(function () { return require('./index-07f61ddd.js'); }),
            Promise.resolve().then(function () { return require('./region-128c6d83.js'); }),
        ]);
    ...
    const [{ groupByOffset }, { DateEngine }] = await Promise.all([
        Promise.resolve().then(function () { return require('./index-27dcb5e8.js'); }),
        Promise.resolve().then(function () { return require('./index-3c6b9765.js'); }),
    ]);
