 ...
 * Generated on Tue, 01 Oct 2024 00:09:17 GMT
 */
/**
 * Do not edit directly
 * Generated on Tue, 01 Oct 2024 00:09:17 GMT
...
/**
 * Do not edit directly
 * Generated on Tue, 01 Oct 2024 00:09:14 GMT
 */
/* mixins & extensions */
...
:host([kind=neutral]) .container .close {
  color: var(--calcite-chip-close-icon-color, var(--calcite-close-icon-color, var(--calcite-color-text-3)));
}
...
.close {
  ...
  block-size: var(--calcite-internal-close-size, 1.5rem /* 24px */);
  inline-size: var(--calcite-internal-close-size, 1.5rem /* 24px */);
  padding: 0;
}
