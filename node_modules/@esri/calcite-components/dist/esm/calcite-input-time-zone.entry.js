...
import { f as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './locale-cc91d254.js';
...
import { c as connectForm, d as disconnectForm, a as afterConnectDefaultValueSet, H as HiddenFormInputSlot } from './form-57a6688d.js';
import './dom-a412467a.js';
...
async function getNormalizer(mode) {
    ...
    const { normalize } = await import('./time-zones-01573571.js');
    return normalize;
}
async function createTimeZoneItems(locale, messages, mode, referenceDate, standardTime) {
    if (mode === "name") {
        const { groupByName } = await import('./index-325ae387.js');
    ...
    if (mode === "region") {
        const [{ groupByRegion }, { getCountry, global: globalLabel }] = await Promise.all([
            import('./index-0c6842b6.js'),
            import('./region-85438bb1.js'),
        ]);
    ...
    const [{ groupByOffset }, { DateEngine }] = await Promise.all([
        import('./index-d1a6d798.js'),
        import('./index-6243176b.js'),
    ]);
