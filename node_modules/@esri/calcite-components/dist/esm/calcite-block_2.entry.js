...
import { c as connectConditionalSlotComponent, d as disconnectConditionalSlotComponent } from './conditionalSlot-d28b5638.js';
import { b as slotChangeHasAssignedElement, f as focusFirstTabbable, e as getSlotted, t as toAriaBoolean } from './dom-a412467a.js';
import { u as updateHostInteraction, I as InteractiveContainer } from './interactive-aa12fe2b.js';
import { c as connectLocalized, d as disconnectLocalized } from './locale-cc91d254.js';
import { u as updateMessages, c as connectMessages, d as disconnectMessages, s as setUpMessages } from './t9n-861497d5.js';
import { H as Heading } from './Heading-e0a7871d.js';
import { c as componentFocusable, s as setUpLoadableComponent, a as setComponentLoaded } from './loadable-c5106ddb.js';
import { o as onToggleOpenCloseComponent } from './openCloseComponent-156fb400.js';
import { b as defaultEndMenuPlacement } from './floating-ui-2530bbcd.js';
import { i as isActivationKey } from './key-f71ed5cc.js';
import './observers-d7a56c1f.js';
import './browser-0dbc8b58.js';
import './guid-8d29c18d.js';
import './resources-d219e37c.js';
import './debounce-714520f0.js';
...
const Block = class {
    ...
    render() {
        ...
        const headerContent = (h("header", { key: '439d2866f9c5f13cfd8020812203a6cdf86c964f', class: { [CSS$1.header]: true, [CSS$1.headerHasText]: !!(heading || description) }, id: IDS$1.header }, this.renderIcon("start"), this.renderContentStart(), this.renderLoaderStatusIcon(), this.renderTitle()));
        const hasControl = !!getSlotted(el, SLOTS.control);
        const hasMenuActions = !!getSlotted(el, SLOTS.headerMenuActions);
        const collapseIcon = open ? ICONS$1.opened : ICONS$1.closed;
        const headerNode = (h("div", { key: 'a9721a9e145db53a215262190d2f7e46472edec6', class: CSS$1.headerContainer }, this.dragHandle ? h("calcite-handle", { label: heading }) : null, collapsible ? (h("button", { "aria-controls": IDS$1.content, "aria-describedby": IDS$1.header, "aria-expanded": collapsible ? toAriaBoolean(open) : null, class: CSS$1.toggle, id: IDS$1.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, h("div", { class: CSS$1.iconEndContainer }, this.renderIcon("end"), h("calcite-icon", { class: CSS$1.toggleIcon, icon: collapseIcon, scale: "s" })))) : this.iconEnd ? (h("div", null, headerContent, h("div", { class: CSS$1.iconEndContainer }, this.renderIcon("end")))) : (headerContent), hasControl ? (h("div", { "aria-labelledby": IDS$1.header, class: CSS$1.controlContainer }, h("slot", { name: SLOTS.control }))) : null, hasMenuActions ? (h("calcite-action-menu", { flipPlacements: menuFlipPlacements ?? ["top", "bottom"], label: messages.options, overlayPositioning: this.overlayPositioning, placement: menuPlacement }, h("slot", { name: SLOTS.headerMenuActions }))) : null, this.renderActionsEnd()));
        return (h(Host, { key: 'cdf7c69cc630466cfd4fb0078735f1e685fde512' }, h(InteractiveContainer, { key: 'ae5b2a044fb337bb2c5c12bee2c9ed4b10e5c373', disabled: this.disabled }, h("article", { key: '01c5c5499d62361cfe26d8b6a878034f0805787b', "aria-busy": toAriaBoolean(loading), class: {
            ...
            } }, headerNode, h("section", { key: 'e72271e369055329e4447d15c2deec25599332ec', "aria-labelledby": IDS$1.toggle, class: CSS$1.content, hidden: !open, id: IDS$1.content }, this.renderScrim())))));
    }
