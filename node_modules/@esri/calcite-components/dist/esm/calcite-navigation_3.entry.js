 ...
 * v2.13.0
 */
import { r as registerInstance, c as createEvent, h, F as Fragment, H as Host, g as getElement } from './index-b39237b3.js';
import { b as slotChangeHasAssignedElement } from './dom-a412467a.js';
...
const CalciteNavigation = class {
    ...
    render() {
        ...
        return (h(Host, { key: 'bf64aa6c6c41bfad6413b58f7897527bb62e1d96' }, h("div", { key: '8c30501a94d5c41e60291c1f0d1cb2856afa5d62', class: {
            ...
            } }, h("div", { key: 'ef4c088fc24566ca24da9abe6a30903fedcad4d9', class: { [CSS$2.hide]: !this.progressSlotHasElement, [SLOTS.progress]: true } }, h("slot", { key: '0abc91e366b542e11ee76f13f099ee8b64a55ee0', name: SLOTS.progress, onSlotchange: this.handleProgressSlotChange })), h("div", { key: '689dc16c2ab71944a78f3bfc16c1c16c9159f073', class: { [CSS$2.containerContent]: true, [CSS$2.hasProgress]: this.progressSlotHasElement } }, this.renderMenuAction(), h("div", { key: '122f9d2d278a0a87dc1774f4933a4bb120410e48', class: { [CSS$2.hide]: !this.logoSlotHasElements, [SLOTS.logo]: true } }, h("slot", { key: '38f2a0106cb2b3a844b60406c629c0cff4c1b64e', name: SLOTS.logo, onSlotchange: this.handleLogoSlotChange })), h("slot", { key: 'af8aa2c6ed65c95c51ebe31314cd1e684beef657', name: SLOTS.contentStart, onSlotchange: this.handleContentStartSlotChange }), h("slot", { key: '989ba0f344ce973ea32b07ee02b04d62068cefb8', name: SLOTS.contentCenter, onSlotchange: this.handleContentCenterSlotChange }), h("slot", { key: 'e0fd2d40efb52e8735ca426c1374a3da4882a77d', name: SLOTS.contentEnd, onSlotchange: this.handleContentEndSlotChange }), h("div", { key: '56e905fef7a76fd14be7085f367d6abf8b44a80b', class: { [CSS$2.hide]: !this.userSlotHasElements, [SLOTS.user]: true } }, h("slot", { key: 'e038f1510da60abbb05c1fd8541563334f86f6d5', name: SLOTS.user, onSlotchange: this.handleUserSlotChange })))), h(Fragment, { key: '3a65439c3774cfb42fa6bc5f12c234a66f8bb314' }, h("slot", { key: '52e0b810e42911da6dc1ea448026f5756df0206f', name: SLOTS.navSecondary, onSlotchange: this.handleSecondarySlotChange }), h("slot", { key: '97c2666bcd896fa763cb84d6b53285e2e26b51d1', name: SLOTS.navTertiary, onSlotchange: this.handleTertiarySlotChange }))));
    }
...
const CalciteNavigationLogo = class {
    ...
    render() {
        ...
        return (h(Host, { key: '40dcb76c1c7919fd1a8b6929616d1d507c1e3301' }, h("a", { key: '7b457d99add3c3d4edbd4478711f9b9c9fb12caf', class: CSS$1.anchor, href: this.href, rel: this.rel, target: this.target }, thumbnail && h("img", { key: '592aa3cfc2dfa47f9aa603f7edce4521dbaa27ae', alt: this.label || "", class: CSS$1.image, src: thumbnail }), this.icon && this.renderIcon(), this.renderHeaderContent())));
    }
