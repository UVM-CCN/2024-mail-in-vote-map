...
var VERSION2 = true ? "9.0.32" : "latest";
...
var H3TileLayer = class extends import_core8.CompositeLayer {
  ...
  renderLayers() {
    ...
    return [
      new spatial_index_tile_layer_default(this.props, {
...
var RasterColumnLayer = class extends import_layers4.ColumnLayer {
  getShaders() {
    const shaders = super.getShaders();
...
var RasterTileLayer = class extends import_core14.CompositeLayer {
  ...
  renderLayers() {
    ...
    return [
      new import_geo_layers7.TileLayer(this.props, {
...
var VERSION3 = true ? "9.0.32" : "latest";
