...
# read the csv file
df = pd.read_csv('external-data/DetailedAbsenteeVotersList_9.30.2024.csv')
...
df.to_csv('external-data/filtered-20240930.csv', index=False)

summary_df.to_csv('external-data/summary-20240930.csv', index=True)
